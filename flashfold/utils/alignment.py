...
from .sequence import Sequence, Infile_feats, get_a3m_records, combine_sequences, \
...
def run_jackhmmer(fasta_files: list, database_fasta: str, provided_cpu: int, out_path: str) -> None:
    ...
    for fasta_file in fasta_files:
        ...
        deduplicate_command = ("python3 %s %s --min_sequences %s --output %s --threads %s"
                                % (deduplicate_script, fas_file_path, min_jackhmmer_hits,
    ...
    for query_hash in query_hashes:
        ...
        for a3m_file, tsv_file in zip(sorted(a3m_files), sorted(tsv_files)):
            ...
            if query_hash == a3m_query_hash and query_hash == tsv_query_hash:
                ...
                a3m_records = get_a3m_records(a3m_file)
